...
void HalfEdgeTriMesh::vertex_face_neighbors( const Index vertex_index, Indices& result ) const
{
    ...
    while( true )
    {
        ...
        // Store the face the half-edge points to if it's not -1.
...
typedef std::map< std::pair< cs451::HalfEdgeTriMesh::Index, cs451::HalfEdgeTriMesh::Index >, cs451::HalfEdgeTriMesh::Index > directed_edge2index_map_t;
cs451::HalfEdgeTriMesh::Index directed_edge2face_index( const directed_edge2index_map_t& de2fi, cs451::HalfEdgeTriMesh::Index vertex_i, cs451::HalfEdgeTriMesh::Index vertex_j )
{
    assert( !de2fi.empty() );
